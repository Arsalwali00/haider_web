<footer>
			<div class="w-100 tq-pt-100 tq-secondary-layer tq-opc1 tq-pb-30 overflow-hidden position-relative">
				<div class="tq-fixed-bg tq-bg-secondary tq-bg-blend-multiply"
					style="background-image: url(images/tq-bg4.jpg);"></div>
				<div class="container">
					<div
						class="tq-footer-top d-flex align-items-center justify-content-between position-relative w-100">
						<div
							class="tq-sec-title-wrapper tq-sec-title-left-icon mb-0 d-flex align-items-center justify-content-between position-relative w-100">
							<div class="tq-sec-title d-flex flex-column">
								<object class="fill-theme position-absolute" data="images/footer-icon.svg" width="100"
									height="100"> </object>
							...
							<a class="tq-theme-btn tq-bg-theme rounded-pill"
								href="https://naudummy.com/muezzin/contact-us/">Join Community</a>
						</div><!-- Section Title Wrapper -->
					</div><!-- Footer Top -->
					<div class="tq-footer-body position-relative w-100">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-lg-3">
								<div class="tq-logo v2 position-relative"><a href="https://naudummy.com/muezzin/"
										title="">
...
c11.74,1.01,18.55,6.68,21.6,17.95c0.69,2.54,1.86,4.14,4.45,4.71C176.75,63.77,180.78,67.35,184,72z"></path>
										...
										<img class="img-fluid position-absolute" src="images/logo-insignia.png.webp"
											loading="lazy"></a>
								</div>
								<!-- Logo -->
							</div>
							...
							<div class="col-md-6 col-sm-6 col-lg-3">
								<div class="widget-box widget widget">

									<div class="tq-widget-box d-flex flex-column position-relative w-100">
										<h4 class="mb-0">Information</h4>
										<p class="mb-0">Elit duis volutpat ligula nulla a getmolestie mi consectetur
											auctor ugue ac tincidunt, var ius felis et, augue lorem. Aliquam accumsan
											fringilla.
										</p>
									</div>
								</div>
		...
		c1.92,0.02,3.63-1.67,3.65-3.61C53.62,33.99,51.94,32.29,50,32.27z">
								...
								<div class="widget-box widget widget">
									<div class="tq-widget-box d-flex flex-column position-relative w-100">
										...
										<ul class="d-flex flex-column list-unstyled mb-0">
											...
											<li>
												<a itemprop="url" href="https://naudummy.com/muezzin/">Home – Islamic
													Center</a>
											</li>
											<li>
												<a itemprop="url"
													href="https://naudummy.com/muezzin/salat-timings/">Salat Timings</a>
											</li>
											<li>
												<a itemprop="url"
													href="https://naudummy.com/muezzin/travel-tours/">Travel & Tours</a>
											</li>
											<li>
												<a itemprop="url"
													href="https://naudummy.com/muezzin/online-classes/">Online
													Classes</a>
											</li>
											<li>
												<a itemprop="url"
													href="https://naudummy.com/muezzin/lp-term-conditions/">Term
													Conditions</a>
											</li>
										</ul>
					...
					<div
						class="tq-footer-bottom d-flex align-items-center justify-content-between position-relative w-100">
						<p itemprop="description" class="mb-0 text-white">Muezzin © Copyright 2025, <a
								href="https://themeforest.net/user/nauthemes">All Rights Reserved</a></p>
						<div class="tq-social-links text-white d-inline-flex align-items-center">
							<a class="brd-rd50" data-toggle="tooltip" data-placement="top" href="https://facebook.com"
								title="" itemprop="url" target="_blank"><i class="fab fa-facebook-f"></i></a>
							<a class="brd-rd50" data-toggle="tooltip" data-placement="top" href="https://twitter.com"
								title="" itemprop="url" target="_blank"><i class="fab fa-twitter"></i></a>
							<a class="brd-rd50" data-toggle="tooltip" data-placement="top" href="https://linkedin.com"
								title="" itemprop="url" target="_blank"><i class="fab fa-linkedin-in"></i></a>
							<a class="brd-rd50" data-toggle="tooltip" data-placement="top" href="https://instagram.com"
								title="" itemprop="url" target="_blank"><i class="fab fa-instagram"></i></a>
						</div><!-- Social Links -->
					</div><!-- Footer Bottom -->
				</div>
			</div>
